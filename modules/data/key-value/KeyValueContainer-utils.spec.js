...
describe("$data", function () {
    ...
    describe("for values", function () {
      describe("to string", function () {
        it("should return STRING value variant", function () {
          expect($data.getMapResultClass(Collection, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringCollection);
          expect($data.getMapResultClass(StringCollection, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringCollection);
          expect($data.getMapResultClass(Dictionary, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringDictionary);
          expect($data.getMapResultClass(StringDictionary, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringDictionary);
          expect($data.getMapResultClass(PairList, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringPairList);
          expect($data.getMapResultClass(StringPairList, null, $data.VALUE_TYPE_STRING))
          .toBe($data.StringPairList);
        });
      });
      ...
      describe("to any", function () {
        it("should return ANY value variant", function () {
          expect($data.getMapResultClass(Collection, null, $data.VALUE_TYPE_ANY))
          .toBe($data.Collection);
          expect($data.getMapResultClass(StringCollection, null, $data.VALUE_TYPE_ANY))
          .toBe($data.Collection);
          expect($data.getMapResultClass(Dictionary, null, $data.VALUE_TYPE_ANY))
          .toBe($data.Dictionary);
          expect($data.getMapResultClass(StringDictionary, null, $data.VALUE_TYPE_ANY))
          .toBe($data.Dictionary);
          expect($data.getMapResultClass(PairList, null, $data.VALUE_TYPE_ANY))
          .toBe($data.PairList);
          expect($data.getMapResultClass(StringPairList, null, $data.VALUE_TYPE_ANY))
          .toBe($data.PairList);
        });
      });
    });
    ...
    describe("for keys", function () {
      describe("to string", function () {
        it("should return self, or Dictionary variants", function () {
          expect($data.getMapResultClass(Collection, $data.KEY_TYPE_STRING, null))
          .toBe($data.Collection);
          expect($data.getMapResultClass(StringCollection, $data.KEY_TYPE_STRING, null))
          .toBe($data.StringCollection);
          expect($data.getMapResultClass(Dictionary, $data.KEY_TYPE_STRING, null))
          .toBe($data.Dictionary);
          expect($data.getMapResultClass(StringDictionary, $data.KEY_TYPE_STRING, null))
          .toBe($data.StringDictionary);
          expect($data.getMapResultClass(PairList, $data.KEY_TYPE_STRING, null))
          .toBe($data.Dictionary);
          expect($data.getMapResultClass(StringPairList, $data.KEY_TYPE_STRING, null))
          .toBe($data.StringDictionary);
        });
      });
      ...
      describe("to any", function () {
        it("should return PairList variants", function () {
          expect($data.getMapResultClass(Collection, $data.KEY_TYPE_ANY, null))
          .toBe($data.PairList);
          expect($data.getMapResultClass(StringCollection, $data.KEY_TYPE_ANY, null))
          .toBe($data.StringPairList);
          expect($data.getMapResultClass(Dictionary, $data.KEY_TYPE_ANY, null))
          .toBe($data.PairList);
          expect($data.getMapResultClass(StringDictionary, $data.KEY_TYPE_ANY, null))
          .toBe($data.StringPairList);
          expect($data.getMapResultClass(PairList, $data.KEY_TYPE_ANY, null))
          .toBe($data.PairList);
          expect($data.getMapResultClass(StringPairList, $data.KEY_TYPE_ANY, null))
          .toBe($data.StringPairList);
        });
      });
    });
  ...
  describe("getSwapResultClass()", function () {
    it("should return swap result class", function () {
      ...
      .toBe($data.StringDictionary);
      expect($data.getSwapResultClass(Dictionary)).toBe($data.StringPairList);
      expect($data.getSwapResultClass(StringDictionary))
      .toBe($data.StringDictionary);
      expect($data.getSwapResultClass(PairList)).toBe($data.PairList);
      expect($data.getSwapResultClass(StringPairList)).toBe($data.Dictionary);
    });
  });
