...
$entity.ItemKey
.forwardTo($oop.mixClass($entity.ItemKey, $oop.getClass('$utils.CachedStringifiable')), function (properties) {
  return $utils.CachedStringifiable.mixedBy(properties.fieldKey);
});
