...
describe("$widgets", function () {
  describe("DomInputElementHost", function () {
    ...
    beforeAll(function () {
      DomInputElementHost = $oop.getClass('test.$widgets.DomInputElementHost.DomInputElementHost')
      .blend($widget.Widget)
      .blend($widgets.Inputable)
      .blend($widgets.DomInputElementHost);
  ...
  describe("InputElementHost", function () {
    ...
    beforeAll(function () {
      InputElementHost = $oop.getClass('test.$widgets.DomInputElementHost.InputElementHost')
      .blend($widget.Widget)
      .blend($widgets.Inputable)
    ...
    describe("create()", function () {
      describe("in browser environment", function () {
        it("should return DomInputElementHost instance", function () {
          ...
          expect($widgets.DomInputElementHost.mixedBy(inputElementHost))
          .toBeTruthy();
        });
      });
    });
